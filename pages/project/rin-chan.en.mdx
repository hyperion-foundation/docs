...
Rin-chan music playlist are provided from [Lofi Girl](https://www.youtube.com/@LofiGirl).

### Project/Bot Version
This type of project doesn't have any version, because there will be no changes for the project.

## Goal Project
Rin-chan purposely made to provide **Lofi** music playlist 24/7 or non-stop. All Hyperion Foundation members can listen Rin-chan on **🎵 Lofi Lounge** (stage channel).
